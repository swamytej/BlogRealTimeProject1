...
from BlogApp1.models import Post,Comment
...
def post_list_view(request):
     ...
     return render(request,'BlogApp1/post_list.html',{'postlist':postlist})
...
def post_list_view(request,tag_slug=None):
    ...
    return render(request,'BlogApp1/post_list.html',{"postlist":postlist,'tag':tag})
...
def signupview(request):
    ...
    if request.method=='POST':
        ...
        form = signupform()
    return render(request,'BlogApp1/signup.html',{'form':form ,'sent':sent})
...
def thankyou1(request):
    return render(request, 'BlogApp1/thankyou1.html')
...
class commentview(CreateView):
    ...
    template_name = 'BlogApp1/comment.html'
...
def commentdelsucc(request):
    return render(request, 'BlogApp1/delete.html')
...
def profileview(request):
    return render(request, 'BlogApp1/user_details.html')
...
def profileupdate(request,pk):
    ...
    print('ok')
    return render(request,'BlogApp1/user_form.html',{'user':user,})
'''
def profileupdate(request,pk):
    user = User.objects.get(id=pk)
    print('hi')
...
def contactview(request):
    return render(request, 'BlogApp1/contact.html')